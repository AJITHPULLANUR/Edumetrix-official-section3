...
import backgroundpng from "../Section3/Section3-Images/backgroundpng.png";
import ajith from "../Section3/Section3-Images/Persons/ajith.jpg";
import anshid from "../Section3/Section3-Images/Persons/ans.jpg";
import sarath from "../Section3/Section3-Images/Persons/SARATH.jpg";
import niyas from "../Section3/Section3-Images/Persons/NIYAS.jpg";
import sinsar from "../Section3/Section3-Images/Persons/SINSAR.jpg";
import farhan from "../Section3/Section3-Images/Persons/FARHAN.jpg";
import appu from "../Section3/Section3-Images/Persons/APPUS.jpg";
import ansil from "../Section3/Section3-Images/Persons/ansil.jpg";
import fahad from "../Section3/Section3-Images/Persons/fahad.jpg";
import sarathlal from "../Section3/Section3-Images/Persons/sarathlal.jpg";
import mishab from "../Section3/Section3-Images/Persons/mishab.jpg";
import priya from "../Section3/Section3-Images/Persons/priya.jpg";
import akhil from "../Section3/Section3-Images/Persons/akhil.jpg";
import jonish from "../Section3/Section3-Images/Persons/jonish.jpg";
            ...
            <div className="section3-cardsecondboxfirstcardsmallupdate">
              <div className="section3-cardsecondboximagedivsmall">
                <div className="section3-cardsecondboximageroundsmall">
                  <img
                    className="section3-cardsecondboximagesmall"
                    src="https://pbs.twimg.com/profile_images/949357419125137408/ddMh0ln7_400x400.jpg"
                    alt=""
                  />
                </div>
              </div>
